...
outer tertiary mass of $m_{\rm 3} = 1.4$ M$_{\odot}$.  (2)
...
the red giant or early asymptotic giant branch.  (5) Relative to
...
\begin{figure}[ht!]
  ...
  \caption{Giant radius as a function of the mass of the core of the
    ...
    after core helium burning stage (to the right).  Only when the
...
the inner binary), although it is hard to actually quantify
...
orbit.  This supports our naive prediction that the spin
...
for the secondary star.  Such high spin rates immediately
