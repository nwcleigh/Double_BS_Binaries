...
apply this scenario to the observed double BS system Binary 7782 in
the old open cluster NGC 188, and show that its observed properties
...
tertiary mass of $m_{\rm 3} = 1.4$ M$_{\odot}$.  After Roche-lobe
overflow, the outer star turns into a white dwarf (WD) of mass 0.43 to
0.54\,\MSun. There is a correlation between the mass of this WD and
the outer orbital period: more massive WDs will be on wider orbits.
(3) The rotational axes of both BSs will be aligned with each other
and the orbital plane of the outer tertiary WD. (4) The BSs will have
roughly equal masses, independent of their initial masses (since the
lower mass star accretes the most).  The dominant accretor should,
therefore, be enriched more effectively by the accreted material.  As
a result, one of the BSs will appear to be more enriched by either He,
C and O or by s-process elements, depending on if the donor started to
overflow its Roche lobe on, respectively, the red giant or asymptotic
giant branch.  (5) Relative to old dense clusters with high-velocity
dispersions, twin BSs in close binaries formed from the proposed
mechanism should be more frequent in the Galactic field and younger
open clusters with ages $\lesssim$ 4-6 Gyr, since then the donor will
have a radiative envelope. (6) the orbit of the binary BS will have a
small semi-major axis (typically $\aplt 0.3$\,au) and be close to
circular ($e \aplt 0.2$).
...
Blue straggler stars are brighter and bluer than the main-sequence
...
10 km s$^{-1}$.  The vertical dashed black lines show the maximum
...
dashed red line shows the observed orbital period for Binary 7782,
...
\citep[see, for example, \S\,3.3 on page 40
  in][]{1995LesHouchesSWhite}. During this procedure, the gaseous
...
\begin{figure*}[ht!]
  \includegraphics[width=0.5\columnwidth]{fig_BBSS_Lgas_M14Msun_A010au_t3360.pdf}
~  \includegraphics[width=0.5\columnwidth]{fig_BBSS_gas_M14Msun_A010au_t3360.pdf}
...
\begin{figure*}[ht!]
  \includegraphics[width=0.51\columnwidth]{fig_orbital_evolution_for_12MSun.pdf}
~  \includegraphics[width=0.49\columnwidth]{fig_orbital_evolution_for_14MSun.pdf}
  \caption{Evolution of the orbital separation as a function of the
    ...
    that the binary evolved towards to observed orbital separation of
...
%Regretfully, we do not really understand the details of this
%process, but then this process is hardly understood in binary
%evolution also.
%NL: I edited the above to be a kinder to us.
...
%NL2: Huh.  This is interesting.  Is the physical reason for it that
%apocenter for the secondary tends to be closer to the circumbinary
%disk?  I don't get why retrograde wins though, since naively I'd have
%thought prograde should lead to lower relative velocities between the
%secondary and the gas flow, and hence to higher accretion rates.
%What am I missing?  Is there momentum cancellation via colliding gas,
%shocks, etc. I am missing somewhere?
%% SPZ: I think that we do not have to add these extra simulations. I
%% found the result sufficiently confusing to check and check
%% again. Maybe we write another paper on these results, or a
%% follow-up on accretion in triples. But maybe it is best to stick to
%% the observed facts, and not try to explore parameter space in
%% extensio. What do you think, Nathan?  At the moment, this last
%% paragraph is a bit of an after though, but maybe it is worth
%% mentioning that our results are consistent with those of others...

\section{Summary} \label{sect:conclusions}

In this paper, we propose a formation scenario for twin equal-mass
blue stragglers in tight binaries, as observed for Binary 7782 in the
...
\item We expect twin BSs in compact binaries formed from the mechanism
  ...
  $\lesssim$ 4-6 Gyr.  This is because clusters with a MS turn-off
  ...
  %\simon{Can we quantify this? - NL: The stability of the accretion...?}
