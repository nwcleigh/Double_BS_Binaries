...
aligned with the orbit of the tertiary white-dwarf star.  If the two
...
core of the star continues to grow but the stellar radius actually shrinks.
...
observed twin BS WOCS 7782. In our simulations the eccentricity of the
...
\cite{2018ApJ...869L..29L}.  Rapidly spinning stars may slow due to,
...
\item For the predicted outer tertiary orbit, the initial orbital
  ...
  $M$_{\odot}$. The final orbital period of the white dwarf
    around the binary blue straggler should exceed the initial
...
%%}.                                                                            
  ...
  The mass ratio of the inner binary, therefore grows to unity.  
    ...
    binaries. With these calculations we demonstrate that a low-mass
  ...
  \caption{Evolution of the mass ratio for initial triples with an
    ...
    mass of the tertiary are indicated in the legend. The dotted black
...
mass. This may result in an unstable phase of mass transfer, in
...
As discussed in Section~\ref{intro}, BS-WD binaries are predicted to be the products of the binary mass transfer hypothesis (ignoring a common envelope phase) for BS formation. However, this mechanism tends to predict wide orbits, which is consistent with the observed BS-WD systems in NGC 188.  
...
%% stars.
If, on the other hand, such a dynamical instability engages relatively late in the
...
observed twin BS WOCS 7782 and the observed masses of the two stars of
about 1.4\,\MSun.
