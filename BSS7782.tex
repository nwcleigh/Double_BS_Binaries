...
observed for low-mass tertiaries \cite{2010yCat..73890925T,moe18} \simon{I
  think that {\em moe18} and {\em tobin18} are not the right
  references - NL: I checked and I think the moe18 reference, at least, is fine, so I added it back in.  But feel free to remove it, if you prefer.}.  This initial configuration for our assumed formation
...
between the inner and the outer orbits, since observed stellar triples composed of low-mass stars have been observed to favor co-planar configurations \citep{moe18}.
