...
initial masses for the inner binary components of $m_{\rm 1} = 1.1$
M$_{\odot}$ and $m_{\rm 2} =$ 0.9 M$_{\odot}$ and an outer tertiary
mass of $m_{\rm 3} = 1.4$ M$_{\odot}$.  After Roche-lobe overflow, the
...
that more massive white dwarfs will be on wider orbits.  (3) The
...
AGB star). (5) Relative to old dense clusters with high velocity dispersions, 
twin BSs in compact binaries formed from the proposed 
...
have a radiative envelope. (6) the orbit of the binary BS will be
compact (typically $\aplt 0.3$\,au) and close to circular ($e \aplt
0.2$).
...
\citep{2001A&A...375..375V,2003AJ....125..810S}.  The observations suggest that the
outer tertiary is itself a BS, with a mass $\sim$ 1.7 M$_{\odot}$ and
orbiting the inner binary with a period of 1188.5 days
\citep{{2003AJ....125..810S}.  The inner binary has a period of only 1.068 days
\citep{2001A&A...375..375V}, and hosts a BS of mass 2.52 M$_{\odot}$.  In
order to form this system \del{after convolving its observed
  properties with its host cluster age,} we require at least five
stars in order to conserve the total system mass \citep{2011MNRAS.410.2370L}.  As
explained in \citet{2011MNRAS.410.2370L}, this is strongly indicative of a
