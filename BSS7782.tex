...
We propose a formation mechanism for twin blue stragglers (BSs) in compact
...
this scenario to the observed double BS system Binary 7782
...
Based on this model, we predict the following properties for twin BSs: (1) For the outer tertiary orbit, the initial orbital
...
mass 0.43 to 0.54\,\MSun. There is a correlation between the mass of this
WD and the outer orbital period: more massive WDs will be on wider orbits.  (3) The rotational axes of both 
BSs will be aligned with each other and the
orbital plane of the outer tertiary WD. (4) The BSs 
will have roughly equal masses, independent of their initial
masses (since the initially lower mass star accretes the most).  The dominant accretor should, therefore, be enriched
more effectively by the accreted material.  As a result, one of the
BSs will appear to be more enriched by either He, C and O or by s-process elements, depending on 
if the donor started to overflow its Roche lobe on, respectively, the red
giant or asymptotic giant branch.  (5) Relative to old dense clusters with high-velocity dispersions, twin BSs in close binaries formed from the
...
will have a small semi-major axis (typically $\aplt 0.3$\,au) and be close to circular ($e
\aplt 0.2$).
...
\item Twin BSs in compact binaries formed from the mechanism proposed here 
  ...
  the accretor.  %\simon{Can we quantify this? - NL: The stability of the accretion...?}

\end{enumerate}

We emphasize in closing that our choice for the initial mass of the
outer tertiary is critical since it ensures that the donor star during
the mass transfer process will have a radiative envelope
\citep[e.g.][]{2009pfer.book.....M}.  In turn, this ensures that the
mass transfer will be maximally conservative, such that the accretion
stream will be maximally stable, accreting at a stable and roughly
constant rate \citep[e.g.][]{1991ApJS...76...55I}.
